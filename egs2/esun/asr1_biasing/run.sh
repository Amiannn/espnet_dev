...
asr_config=conf/exp/train_asr_transducer_conformer_dummy.yaml
...
pretrained_model=./exp/asr_train_asr_transducer_conformer_raw_bpe3949_use_wandbtrue_sp_suffix/valid.loss.ave_10best.pth
